...
module.exports = function (Twig) {
    ...
    Twig.filters = {
        ...
        json_encode: function json_encode(value) {
            if (value === undefined || value === null) {
                return "null";
            } else if ((typeof value === "undefined" ? "undefined" : _typeof(value)) == 'object' && is("Array", value)) {
                output = [];
                ...
                return "[" + output.join(",") + "]";
            } else if ((typeof value === "undefined" ? "undefined" : _typeof(value)) == 'object' && is("Date", value)) {
